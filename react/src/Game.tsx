    ...
    return (
      <div className="game">
        ...
        <div className="game-info">
          ...
          <div>
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris purus mi, posuere in ex ut, commodo aliquet sem. Curabitur non metus in lorem pharetra imperdiet ut eu risus. Pellentesque gravida leo enim, sed ullamcorper enim porttitor ac. Donec ullamcorper purus a leo pretium, in euismod nibh tristique. Nunc aliquet augue nec nunc viverra, ac semper velit facilisis. Nulla aliquam quis lectus vel faucibus. Nulla facilisi. Pellentesque vel purus lacus. Vestibulum dignissim diam nec dolor consectetur, et molestie sem pharetra. Vestibulum at sodales ipsum. Morbi consectetur orci nibh, et aliquam orci accumsan at.</p>
